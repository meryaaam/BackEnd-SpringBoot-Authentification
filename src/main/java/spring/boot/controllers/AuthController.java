...
import spring.boot.repository.RoleRepository;
import spring.boot.repository.UserRepository;
import spring.boot.security.jwt.JwtUtils;
import spring.boot.security.services.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		if (strRoles == null) {
			Role userRole = roleRepository.findByName(ERole.ROLE_USER).orElseThrow(() -> new RuntimeException("Empty !"));
			roles.add(userRole);
		} else {
